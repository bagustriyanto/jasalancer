...
@section('content')
    ...
    <div id="home" class="la-home-page">
        ...
        @endif
        <div class="wt-haslayout wt-bannerholder wt-newbanner" style="background-image:url({{{ asset(Helper::getHomeBanner('image')) }}})">
            <div class="container">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12" style="text-align:center">
                            <h1 class="title-joinus">{{ trans('lang.join_with_us') }}</h1>
                        </div>
